import 'package:drugcart/delivery_boy.dart/controller/delivery_login_controller.dart';
import 'package:drugcart/delivery_boy.dart/modal/delivery_login_modal.dart';
import 'package:drugcart/delivery_boy.dart/view/delivery_forgot.dart';
import 'package:drugcart/delivery_boy.dart/view/delivery_register.dart';
...
class _DeliveryLoginState extends State<DeliveryLogin> {
  ...
  final Delivery_Login_Controller _delivery_login_controller = Delivery_Login_Controller();
  @override
                        ...
                        children: [
                          ...
                          Positioned(
                            ...
                            child: TextButton(onPressed: () {
                              Navigator.push(context, MaterialPageRoute(builder: (context) => DeliveryForgot(),));
                              ...
                              child: SizedBox(
                                ...
                                child: ElevatedButton(onPressed: () {
                                  if(_formkey.currentState!.validate()){
                                    ...
                                    _delivery_login_controller.loginDelivery(delloginmodal, context);

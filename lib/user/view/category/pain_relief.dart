...
class PainRelief extends StatefulWidget {
  ...
  @override
  State<PainRelief> createState() => _PainReliefState();
}

class _PainReliefState extends State<PainRelief> {
  ...
  void initState(){
    super.initState();
    _medicineStream = _firestore.collection('Medicineadd').where("category", isEqualTo: "Pain Relief").snapshots();
  }
  @override
